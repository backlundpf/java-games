...
//	player2guess = player2.userguess();
	...
	player1guess = playerarray[0].userguess();
	...
	if ((player1guess.compareTo("Scissors") == 0)  && (player2guess.compareTo("Rock") == 0) )
		System.out.println("Player 2 smashes the heck out of player 1 with a rock! Die scissors die!");
	if ((player1guess.compareTo("Paper") == 0)  && (player2guess.compareTo("Rock") == 0) )
		System.out.println("Player 1 smothers player 2 with paper! Die rock die!");
	if ((player1guess.compareTo("Rock") == 0)  && (player2guess.compareTo("Paper") == 0) )
		System.out.println("Player 2 smothers player 1 with paper! Die rock die!");
	if ((player1guess.compareTo("Scissors") == 0)  && (player2guess.compareTo("Paper") == 0) )
		System.out.println("Player 1 slices and dices player 2 with scissors! Die paper die!");
	if ((player1guess.compareTo("Paper") == 0)  && (player2guess.compareTo("Scissors") == 0) )
		System.out.println("Player 2 slices and dices player 1 with scissors! Die paper die!");
